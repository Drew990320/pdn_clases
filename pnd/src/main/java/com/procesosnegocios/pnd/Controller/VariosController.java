...
/**
 * VariosController - Controlador con funcionalidades diversas
 * 
 ...
 * - GET /api/varios/random → Número aleatorio (0-100)
 * - GET /api/varios/random/param → Número aleatorio con límite (query param)
 * - GET /api/varios/random/{maximo} → Número aleatorio con límite (path variable)
 * - GET /api/varios/random/rango → Número en rango específico
 * - GET /api/varios/saludar → Saludo con datos (query params)
 * - GET /api/varios/saludar/{nombre}/{edad} → Saludo con datos (path variables)
 * - GET /api/varios/estudiantes → Lista de 13 personajes de Marvel
 * - GET /api/varios/emoji → Emoji aleatorio
 * - GET /api/varios/emoji/{cantidad} → Múltiples emojis aleatorios
 * - GET /api/varios/info → Información del controlador
 * 
 * 🔗 URLs COMPLETAS PARA POSTMAN:
 * - http://localhost:8080/api/varios/random
 * - http://localhost:8080/api/varios/random/param?maximo=50
 ...
 * - http://localhost:8080/api/varios/saludar/Luis/28
 ...
 * - /api/varios/random/50 → "Número aleatorio entre 0 y 50: 23"
 * - /api/varios/emoji/3 → "3 emojis aleatorios: 😀 😃 😄"
 * - /api/varios/estudiantes → Lista numerada de 13 personajes de Marvel
 * - /api/varios/saludar/Juan/25 → "Hola tienes Juan y 25"
 * 
 * 🎯 TIPS PARA POSTMAN:
 * - Todos son GET requests (no necesitan body)
 * - Query parameters: ?nombre=Juan&edad=25
 * - Path variables: /Juan/25
 * - Respuestas en texto plano
 * - Los números aleatorios cambian en cada request
 * - Los emojis y estudiantes se generan aleatoriamente
 * 
 ...
 *    - http://localhost:8080/api/varios/emoji/5
 * 
 * 💡 TIP: Los números aleatorios y emojis cambian cada vez que recargas la página
 */
@RestController
