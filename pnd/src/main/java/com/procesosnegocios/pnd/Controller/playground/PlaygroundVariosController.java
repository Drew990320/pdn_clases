...
/**
 * PlaygroundVariosController (Advanced) - Controlador CRUD avanzado para personajes de Marvel
 * 
 ...
 * - GET /api/playground/advanced → Obtener todos los personajes
 * - GET /api/playground/advanced/{index} → Obtener personaje por índice
 * - POST /api/playground/advanced → Agregar nuevo personaje
 * - PUT /api/playground/advanced/{index} → Actualizar personaje existente
 * - DELETE /api/playground/advanced/{index} → Eliminar personaje específico
 * - DELETE /api/playground/advanced → Eliminar todos los personajes
 * 
 * 🔗 URLs COMPLETAS PARA POSTMAN:
 * - GET http://localhost:8080/api/playground/advanced
 * - GET http://localhost:8080/api/playground/advanced/0
 * - POST http://localhost:8080/api/playground/advanced
 * - PUT http://localhost:8080/api/playground/advanced/0
 * - DELETE http://localhost:8080/api/playground/advanced/0
 * - DELETE http://localhost:8080/api/playground/advanced
 * 
 ...
 * - GET /api/playground/advanced → Lista JSON de todos los personajes
 * - GET /api/playground/advanced/0 → "Spider-Man" (primer personaje)
 * - POST → {"mensaje": "Personaje agregado exitosamente", "personaje": "Wolverine", "total": 46}
 * - PUT → {"mensaje": "Personaje actualizado exitosamente", "personaje_anterior": "Spider-Man", "personaje_nuevo": "Wolverine", "indice": 0}
 ...
 * - Este controlador es idéntico al CRUD pero en endpoint diferente
 * - Útil para probar operaciones CRUD sin afectar el controlador principal
 * 
 ...
 * 
 * 📋 VER PERSONAJES (Advanced):
 *    - http://localhost:8080/api/playground/advanced
 *      (Muestra todos los personajes en formato JSON)
 * 
 * 👤 VER PERSONAJE ESPECÍFICO (Advanced):
 *    - http://localhost:8080/api/playground/advanced/0
 *      (Muestra el primer personaje: "Spider-Man")
 *    - http://localhost:8080/api/playground/advanced/1
 *      (Muestra el segundo personaje: "Iron Man")
 *    - http://localhost:8080/api/playground/advanced/2
 ...
 */
@RestController
@RequestMapping("/api/playground/advanced")
public class PlaygroundVariosController {
